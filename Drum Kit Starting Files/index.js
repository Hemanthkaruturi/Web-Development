...
numberOfDrumButtons = $(".drum").length;
...
$("footer p").on("mouseover", function () {
  $("footer p").addClass('increase-font');
});

$("footer p").on("mouseout", function () {
  $("footer p").removeClass('increase-font');
});
